...
•	Cloud Development (AWS/Azure) (8 yrs.)
•	Azure (2 yrs.)
•	CI/CD Development (7 yrs.)
•	Scrum Methodology (8 yrs.)
•	JavaScript Development (8 yrs.)
•	Test Driven Development (TDD) (3 yrs.)
•	Scrum/Agile Methodology (8 yrs.)
•	Workflow Management (8 yrs.)
•	Single Page Application (8 yrs.)
•	Microservices
•	REST APIs (8 yrs.)
...
Frameworks
React (8 yrs.), Next.js (3 yrs.), Django (4 yrs.), Spring Boot (2yr)
Software/COTS
       Git (8 yrs.), NPM (8 yrs.), Docker (7 yrs.) Jest (7 yrs.), MySQL (4 yrs.), Docker (6 yrs.), Jenkins (4 yrs.),     
       Postgres (4 yrs.), Groovy (1 yrs.), SVN (1 yrs.)
Operating Systems
Linux (8 yrs.), Mac (10 yrs.)
...
•	Supervised 2 staff engineers and assisted dev lead for planning, story deconstruction & estimation, and provided team leadership for agile ceremonies and pre-DevOps software development and CI/CD.
•	Ongoing feature development and O&M software development for the Benefits.gov umbrella of web sites (GovLoans, SSABest, Benefits.gov)
...
	Integrated feedback and planning of software development/DevSecOps by automating failed pipeline stages to create Jira Bug Tickets using REST Apis
	Deconstructed existing non-CI/CD software applications and refactored architecture for CI/CD 
	Coordinated software application licensing for over 10 applications across Dev & Prod environments in multiple tier DOD Impact Security level cloud environments (AWS)


Lockheed Martin, Software Engineer	10/2019 – 8/2020
Manassas, VA
(See below Insight Global experience project description)
...
	Wrote unit tests for high percentage code coverage, integration, and functionality
	Sped up team feature product development by reducing resource bottlenecks
	Developed and maintained local mock REST API server in Node.js/Express.js
	Maintained CI/CD Infrastructure and source control with Jenkins & Atlassian Jira/Bitbucket/Confluence
	Presented new JavaScript framework and library technologies via Lunch -n- Learn and Software Improvement Group meetings

Major Accomplishments
 Deployed major legacy JavaScript frontend refactor to modern React frontend to setup a client-side framework for modern software development and was awarded a Bravo award (2019).
...
	Converted legacy Perl codebase applications to Node.js scripts for data collection and analysis.
	Developed a script which compared multiple data-sources and de-duplicated
...
•	Resolved Tier 1-2 service level incidents, authored PBS SolutionCenter knowledge-based articles, managed user provisioning for over 600 PBS staff and 1,300 external collaborators via Single Sign-On (SSO) for Box.com, streamlined collaboration across 11+ initiatives, coordinated the migration of 500+ PCs from Windows XP to Windows 7, and proposed $9,000 yearly savings in account membership dues, achieving significant time and cost savings while enhancing enterprise collaboration and technical support capabilities.

Major Accomplishments
Administered cross-account merging of PBS and PBS subsidiary Box.com business accounts for increased enterprise collaboration efforts and ease in sharing, proposed $9,000 yearly savings in account membership dues, as well as uncounted but considerable IT savings. Enabled document and idea sharing across internal/external organizations, extending to the 300+ PBS member stations.

EDUCATION
BS Hospitality & Tourism Management, Virginia Tech, 2004
