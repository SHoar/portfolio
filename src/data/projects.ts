...
const projects: Project[] = [
  {
    ...
    company: "Federal Consulting Firm",
    agency: "DoD Client",
    dateRange: "June 2025 - Present",
    description: "Full-stack microservice architecture with React frontend and Python FastAPI backend",
  ...
  },
  {
    ...
    company: "Federal Consulting Firm",
    agency: "Federal Client",
    dateRange: "Sept 2022 - March 2024",
    description: "Legacy React/Drupal migration to Next.js framework",
  ...
  },
  {
    ...
    impact: "Automated CI/CD pipelines with Jenkins Templating Engine, integrated security scanning for compliance, and coordinated software licensing across 10+ applications in multi-tier cloud environments.",
    logoUrl: "", // Using fallback badge
    link: "#"
  },
  {
