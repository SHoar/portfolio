        ...
        <div className="max-w-6xl mx-auto">
          <div className="glass-card p-6 md:p-8 lg:p-10">
            ...
            <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
              <iframe
                src="https://shoar.github.io/Tech_Talks/talks/keynote-rvnug-techtalk-092025/index.html#0"
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a 
                href="https://shoar.github.io/Tech_Talks/talks/keynote-rvnug-techtalk-092025/index.html#0"
                target="_blank"
